...
{
    public static bool Title(string title, Font _font= default)
    {
        var titleCentered = new GUIStyle(GUI.skin.textArea) 
        { alignment = TextAnchor.MiddleCenter, fontSize = 24, font = _font , margin = new RectOffset(100, 100, 0, 0) };
        EditorGUILayout.LabelField(title, titleCentered, GUILayout.Height(50));
    ...
    public static bool Foldout(string title, bool display, int fontSize = 16, TextAnchor anchor = TextAnchor.MiddleLeft)
    {
        var style = new GUIStyle("ShurikenModuleTitle");
        style.font = new GUIStyle(EditorStyles.label).font;

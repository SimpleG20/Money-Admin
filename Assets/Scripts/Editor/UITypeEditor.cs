...
public class UITypeEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        CustomUIBase.Title("UI Button by ASGD", Resources.Load<Font>("Fonts/Sans Mateo 2 Semi Bold"));
    ...
    public static bool PageParams(bool display)
    {
        ...
        if (display)
        {
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                string[] names = new string[] { "Title Text Component" };
                ...
                {
                    GUILayout.Space(5);
                    EditorGUILayout.PropertyField(so.FindProperty("pageBtParams.clickEvent"), new GUIContent("On Click Event"));
                }
            }
        }
        return display;
